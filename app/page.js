        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 md:p-12 w-full max-w-md mx-auto">
          ...
          <div className="text-center mt-8">
            <p className="text-white/60 text-sm">
              Join thousands of food lovers and restaurants
            </p>
            <div className="flex justify-center space-x-6 mt-4">
              <div className="text-white/40 text-xs">🍕 Fast Delivery</div>
              <div className="text-white/40 text-xs">⭐ Quality Food</div>
              <div className="text-white/40 text-xs">💳 Secure Payment</div>
            </div>
          </div>
        </div>
      </div>
